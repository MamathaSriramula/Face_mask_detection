...
def send_email_alert(subject, body, to_email):
    sender_email = "mamathasriramula9@gmail.com"
    sender_password = "phlzkbaredwgeyxl"  # <- paste the 16-char app password (no spaces)
            ...
            if label == "Without Mask":
                ...
                if current_time - last_alert_time > alert_interval:
                    ...
                    send_email_alert(
                        ...
                        to_email="mamathasriramula9@gmail.com"  # or any recipient
                    )
